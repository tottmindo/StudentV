...
const camelCaseColumns: Record<string, string> = {
  ...
  averagecoldwatertemp: "averageColdWaterTemp", averagewarmwatertemp: "averageWarmWaterTemp",
  minimumcoldwatertemp: "minimumColdWaterTemp", maximumcoldwatertemp: "maximumColdWaterTemp",
  minimumwarmwatertemp: "minimumWarmWaterTemp", maximumwarmwatertemp: "maximumWarmWaterTemp",
