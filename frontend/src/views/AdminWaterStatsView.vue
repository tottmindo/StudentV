        ...
        <section class="rounded-2xl border border-border-border bg-background p-5 shadow-sm dark:bg-surface-dark">
          <div class="flex flex-wrap items-end justify-between gap-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
              <label class="min-w-40 text-sm font-bold">{{ t('adminWater.chooseHouse') }}<select v-model="house" class="mt-1 block w-full rounded-xl border border-border-border bg-transparent p-2.5 font-normal"><option v-for="value in houses" :key="value" :value="value">{{ value }}</option></select></label>
          ...
          <div class="mt-5 grid gap-5 lg:grid-cols-2">
            <div>
              ...
              <div class="mt-2 grid gap-3 sm:grid-cols-3">
                <label class="text-sm font-semibold">{{ t('adminWater.house') }}<select v-model="exportHouse" class="mt-1 block w-full rounded-xl border border-border-border bg-transparent p-2.5 font-normal"><option value="all">{{ t('adminWater.allHouses') }}</option><option v-for="value in houses" :key="value" :value="value">{{ value }}</option></select></label>
