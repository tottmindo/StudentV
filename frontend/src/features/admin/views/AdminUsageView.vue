...
const labels = computed<Record<string, string>>(() => ({ login: t('auth.login'), 'forgot-password': t('auth.forgotTitle'), 'reset-password': t('auth.resetTitle'), home: t('nav.home'), survey: t('nav.surveys'), answersurvey: t('usageAdmin.answerSurvey'), createsurvey: t('usageAdmin.createSurvey'), stats: t('usageAdmin.statistics'), account: t('usageAdmin.account'), events: t('nav.events'), community: t('nav.community'), information: t('nav.information'), cleaning: t('nav.cleaning'), admin: t('nav.administration'), 'admin-events': t('adminEvents.title'), 'admin-cleaning-tasks': t('adminCleaning.title'), 'admin-water-analytics': t('nav.waterAnalytics'), 'admin-app-usage': t('usageAdmin.title'), chat: t('usageAdmin.chat'), chatroom: t('usageAdmin.chatRoom'), 'change-password': t('usageAdmin.changePassword') }))
