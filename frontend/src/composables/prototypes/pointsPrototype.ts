/* 
DESCRIPTION: This file contains the prototype logic for computing points based on weekly water consumption. It accepts consumption data for a single corridor
